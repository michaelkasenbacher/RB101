...
# Questions:
# 1) can this be done without the use of instance variables? The reason why I used instance variables was
# that I got this error message otherwise: "undefined local variable for main:Object (NameError)" 

# 2) if I comment "+= 1" in who_wins? and uncomment keep_score I get strange results: 
